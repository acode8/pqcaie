...
metrics = ["Mean Absolute Error", "R-squared", "Training Time (s)", "Testing Time (s)"]
colors = ['b', 'g', 'r', 'c', 'm']
...
# Comparison bar for Performance Metrics (Mean Absolute Error, R-squared)
performance_df[["Mean Absolute Error", "R-squared"]].plot(kind='bar', figsize=(12, 6), colormap='viridis', alpha=0.8)
...
sns.boxplot(data=performance_df[["Mean Absolute Error", "R-squared"]], palette="coolwarm")
